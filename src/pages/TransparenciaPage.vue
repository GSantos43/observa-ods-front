...
const sources = [
  {
    ...
    text: 'Bases institucionais de receitas, despesas, contratos, convênios e serviços públicos.',
  ...
  },
  {
    ...
    text: 'Documentos, painéis e publicações que ajudam a qualificar a leitura dos dados.',
    icon: 'article',
  },
];
</script>
